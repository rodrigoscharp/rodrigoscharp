...
- `100k+ orders/s, sub-100µs p99` is `1` — the Athena project row is its only home. The final review removed the duplicate from the capabilities bullet as redundant with the projects table.
